...
@Component({
  selector: 'app-view-template1',
  templateUrl: './view-template1.component.html',
  styleUrls: ['./view-template1.component.scss']
})
export class ViewTemplate1Component implements OnInit {
