...
@Component({
  selector: 'app-view-template2',
  templateUrl: './view-template2.component.html',
  styleUrls: ['./view-template2.component.scss']
})
export class ViewTemplate2Component implements OnInit {
