...
@Component({
  selector: 'app-view-template3',
  templateUrl: './view-template3.component.html',
  styleUrls: ['./view-template3.component.scss']
})
export class ViewTemplate3Component implements OnInit {
      ...
      .subscribe((result) => {
        ...
        this.cardService.getRoleByRoleId(this.userPdf.roleId)
          .subscribe((result) => {
            ...
            this.getBase64ImageFromUrl(this.userPdf.backgroundImage)
              .then(result => this.backgroundImageBase64 = result)
