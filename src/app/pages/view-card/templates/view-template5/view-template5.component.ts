...
@Component({
  selector: 'app-view-template5',
  templateUrl: './view-template5.component.html',
  styleUrls: ['./view-template5.component.scss']
})
export class ViewTemplate5Component implements OnInit {
