...
@Component({
  selector: 'app-view-template7',
  templateUrl: './view-template7.component.html',
  styleUrls: ['./view-template7.component.scss']
})
export class ViewTemplate7Component implements OnInit {
