...
@Component({
  selector: 'app-view-template8',
  templateUrl: './view-template8.component.html',
  styleUrls: ['./view-template8.component.scss']
})
export class ViewTemplate8Component implements OnInit {
