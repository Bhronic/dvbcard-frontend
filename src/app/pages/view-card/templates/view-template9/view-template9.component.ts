...
@Component({
  selector: 'app-view-template9',
  templateUrl: './view-template9.component.html',
  styleUrls: ['./view-template9.component.scss']
})
export class ViewTemplate9Component implements OnInit {
